...
TRANSLATE_NOOP("FullscreenUI", "Determines the size of achievement notification popups.");
TRANSLATE_NOOP("FullscreenUI", "Determines the size of challenge/progress indicators.");
...
TRANSLATE_NOOP("FullscreenUI", "Indicator Scale");
...
TRANSLATE_NOOP("FullscreenUI", "Sets the custom scale percentage for achievement notifications.");
TRANSLATE_NOOP("FullscreenUI", "Sets the custom scale percentage for challenge/progress indicators.");
...
TRANSLATE_NOOP("FullscreenUI", "Use OSD Scale");
